...
class _CategoryProductsPageState extends State<CategoryProductsPage> {
  ...
  Future<void> _loadProducts() async {
    ...
    try {
      final results =
          await ItemOwnerService.fetchItemsByCategory(widget.categoryId);
...
// }
  ...
  Widget _buildMainView() {
    ...
    final productsPage =
        (startIndex < endIndex) ? filtered.sublist(startIndex, endIndex) : [];
        ...
        child: _isLoading
            ? Center(
                child: Column(
                  ...
                  children: [
                    LogoLoading(), // your custom loading widget
